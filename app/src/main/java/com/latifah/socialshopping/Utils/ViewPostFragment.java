...
public class ViewPostFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mComment=(ImageView)view.findViewById(R.id.speech_buble);
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for(DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
                        ...
                        //newPhoto.setDate_create(objectMap.get(getString(R.string.field_date_created)).toString());
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for(DataSnapshot singleSnapshot: dataSnapshot.getChildren()){
                        ...
                        //case 1:Then the user already liked the photo
    ...
    private void getPhotoDetails(){
        ...
        DatabaseReference reference=FirebaseDatabase.getInstance().getReference();
        Query query=reference
                .child(getString(R.string.dbnmae_users_account_settings))
                .orderByChild(getString(R.string.field_user_id))
...
//        String timestampDif=getTimestampDifference();
//        if(!timestampDif.equals("0")){
//            mTimestamp.setText(timestampDif + "DAYS AGO");
//        }else {
...
//        }
    ...
    private String getTimestampDifference(){
        ...
        sdf.setTimeZone(TimeZone.getTimeZone("Canada/Pasific")); //google "android list of timezones'
        Date today=c.getTime();
        sdf.format(today);
        Date timestamp;
        final String photoTimeStamp=mPhoto.getDate_create();
        try{
