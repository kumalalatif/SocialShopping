...
public class ViewCommentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ////ada firstcommet video 79 menit 02.33
    ...
    * Setup the firebase auth object
    ...
    private void setupFirebaseAuth(){
        ...
        if(mPhoto.getComments().size() == 0){
            ...
            firstComment.setDate_created(mPhoto.getDate_create());
...
//                                    photo.setDate_create(objectMap.get(mContext.getString(R.string.field_date_created)).toString());
